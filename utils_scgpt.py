...
def load_dataloader(n_fold,args):
    ...
    tr_items_small = tr_items_raw[:130000]
    ...
    #tr_dataloader = DataLoader(tr_dataset[:960], batch_size=args.batch_size, shuffle=False, num_workers=4, drop_last=True)
    #val_dataloader = DataLoader(val_dataset[:960], batch_size=args.batch_size, shuffle=False, num_workers=4, drop_last=True)
    #test_dataloader = DataLoader(test_dataset[:960], batch_size=args.batch_size, shuffle=False, num_workers=4, drop_last=True)
