...
from models.model_geneformer import SynergyxNet
from utlis_geneformer import (EarlyStopping, collect_env, load_dataloader, load_infer_dataloader, 
...
def arg_parse():
    ...
    # 添加 Geneformer 相关参数
    parser.add_argument('--use-geneformer', type=int, default=1,
                        help='whether to use Geneformer for gene feature extraction (0 for not, 1 for yes)')
    parser.add_argument('--geneformer-hidden-size', type=int, default=256,
                        help='hidden size for Geneformer feature transformation')
