...
from models.model_dose import SynergyxNet
from utlis_dose import (EarlyStopping, collect_env, load_dataloader, load_infer_dataloader, 
...
def arg_parse():
    ...
    # 添加 Geneformer 相关参数
    parser.add_argument('--use-geneformer', type=int, default=0,
